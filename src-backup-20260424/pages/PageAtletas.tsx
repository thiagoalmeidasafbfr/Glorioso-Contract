...
export default function PageAtletas() {
  ...
  return (
    <div style={{ padding: '8px 12px', maxWidth: 1600, margin: '0 auto', fontFamily: font }}>
      ...
      {/* ── Painel principal ── */}
      <div style={{ display: 'grid', gridTemplateColumns: '150px auto auto auto 1fr', gap: 6, marginBottom: 6 }}>
        ...
        <div style={{ display: 'flex', gap: 4 }}>
          {/* Info do contrato */}
          <div className="card" style={{ padding: '8px 12px', width: 140, display: 'flex', flexDirection: 'column', gap: 5 }}>
            {/* Início / Fim / % SAF */}
            {[
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, width: 180 }}>
            <TFCard
              ...
              value={a.transferFeeTotal > 0 ? fmtMiC(convert(a.transferFeeTotal, a.transferFeeMoeda)) : `${a.transferFeeMoeda === 'BRL' ? symbol : a.transferFeeMoeda} 0,0`}
            ...
            <TFCard label={t('Valor Pendente')} sub="(Transfer Fee)"
              value={a.transferFeePendente > 0 ? fmtMiC(convert(a.transferFeePendente, a.transferFeeMoeda)) : `${a.transferFeeMoeda === 'BRL' ? symbol : a.transferFeeMoeda} 0,0`}
        ...
        <div className="card" style={{ padding: '8px 12px', display: 'flex', flexDirection: 'column', gap: 5, width: 180 }}>
          {[
