...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AppContext.Provider value={{ currency, setCurrency, language, setLanguage, symbol, fromBRL, convert, fmtMiC, fmtC, t, currentPage, setCurrentPage, openAtletaId, navigateToAtleta, clearOpenAtleta }}>
      {children}
    </AppContext.Provider>
  )
}
