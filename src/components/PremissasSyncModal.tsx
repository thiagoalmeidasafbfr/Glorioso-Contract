...
export default function PremissasSyncModal({ diffs, onClose, onConfirm }: {
  ...
  const th: React.CSSProperties = { padding: '6px 8px', fontSize: 11, fontFamily: mono, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', textAlign: 'left', borderBottom: '1px solid var(--divider-soft)' }
