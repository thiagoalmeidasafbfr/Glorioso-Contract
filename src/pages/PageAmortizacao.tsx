...
import { fetchPtaxRates, ptaxRateFor, fetchPtaxOn } from '../lib/ptax'
import { fmtCurrencyShort, fmtCurrencyFull, fmtPercent, fmtDate } from '../lib/format'
import type {
  Athlete, Contract, Clause, Currency,
} from '../types/athlete-system'
import PageHero from '../components/PageHero'
import KpiPill from '../components/KpiPill'
import FechamentoCompetencia, { type ClosingCalc } from '../components/FechamentoCompetencia'
import {
  INTANGIBLE_CLAUSE_TYPES, buildAthleteCalcs, calcSale, todayISO,
  type AthleteCalc, type SaleInputs,
